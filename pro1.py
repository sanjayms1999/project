...
def p_hp():
      ...
      c.pack()
      photo=PhotoImage(file=r'C:\\Users\\Admin\\Desktop\\bgss.png')
...
def doc_hp():
      ...
      c=Canvas(login_screen,width=1024,height=800,bg="white")
      c.pack()
      photo=PhotoImage(file=r'C:\\Users\\Admin\\Desktop\\bgs.png')
      background_label=Label(login_screen,image=photo)
      background_label.place(x=0,y=0)
...
def doctor_page():
    ...
    b1= Button(login_screen, text="Back",width=10,height=2,bd=1,command=home_page).place(x=0,y=0),doctor_page.Destroy()
